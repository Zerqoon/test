...
const staff=new Set(['warn','unwarn','wyczysc','timeout','untimeout','kick','ban','unban','slowmode','zamknij','otworz','rola','xp','monety_admin','diagnostyka']);
...
export async function handleAdmin(i,store){
  ...
  const tier=staffTier(i),required=['rola','xp','monety_admin','diagnostyka'].includes(name)?3:
