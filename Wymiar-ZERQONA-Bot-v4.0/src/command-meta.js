...
const entry = (category, tier, summary, usage, details) => ({
  category,
  tier,
  summary,
  usage,
...
export const categories = {
  start: 'Start i informacje',
  profil: 'Profil i poziomy',
  ekonomia: 'Ekonomia i bank',
  sklep: 'Sklep i kolekcja',
  zabawa: 'Zabawa i ankiety',
  glos: 'Pokoje głosowe',
  moderacja: 'Moderacja',
...
export const commandMeta = {
  // ─────────────────────────────────────────────────────────────
  // EKONOMIA — NAGRODY / BANK / DASHBOARD
  // ─────────────────────────────────────────────────────────────
  weekly: entry(
    'ekonomia',
    0,
  ...
  bank: entry(
    ...
    '/bank saldo | wplac ilosc:500 | wyplac ilosc:500',
    'Przelewy wewnętrzne bez prowizji. Bank nie nalicza odsetek. Gry i sklep używają tylko monet w portfelu.',
  ),
  ekonomia: entry(
    'ekonomia',
    0,
    'Pokaż graficzny dashboard portfela, banku, historii i nagród.',
    '/ekonomia',
    'Domyślnie karta jest publiczna; opcja prywatnie ukrywa ją przed kanałem. Canvas pokazuje realny przepływ monet z ostatnich 7 dni.',
  ),

  // ─────────────────────────────────────────────────────────────
  // PROFIL — OSIĄGNIĘCIA / PERSONALIZACJA
  // ─────────────────────────────────────────────────────────────
  osiagniecia: entry(
    'profil',
    0,
  ...
  poziomy: entry(
    ...
    '/poziomy',
    '12–18 XP za tekst co 45 s, 8 XP/min za aktywne VC. Rola Booster daje 2×, a czasowe boosty sklepu 1,5× lub 2× XP; łącznie maksymalnie 4×.',
  ),
  ...
  praca: entry(
    'ekonomia',
    0,
    'Wykonaj zadanie i pokaż publiczną kartę wypłaty; bazowo 100–240 monet co 45 minut.',
    '/praca',
    'Po udanej pracy bot publikuje kartę Canvas z kwotą, bonusem czasowym, saldem i terminem kolejnej zmiany.',
  ),
  nagrody: entry(
    'ekonomia',
    0,
    ...
    '/nagrody',
    'Panel może być publiczny albo prywatny. Każdy boost jest czasowy; kolejna sztuka tego samego mnożnika dopisuje czas zamiast tworzyć stały bonus.',
  ),
  przelew: entry(
    'ekonomia',
    0,
    'Przekaż od 1 do 1 000 000 000 monet innej osobie na serwerze.',
    '/przelew osoba:@osoba ilosc:500',
  ...
  plecak: entry(
    ...
    '/plecak',
    'Tytuły i kosmetyki możesz zakładać bez zużywania. Boost czasowy znika z plecaka po aktywacji i działa tylko przez podany czas.',
  ),
  uzyj: entry(
    'sklep',
    0,
    'Aktywuj posiadany bonus XP albo załóż kupiony tytuł.',
    '/uzyj przedmiot:xp_boost',
  ...
  moneta: entry(
    ...
    '/moneta strona:orzel [stawka:100]',
    'Obie strony mają szansę 50%. Trafienie wypłaca 2× stawkę (zysk 1×), przegrana zabiera stawkę.',
  ),
  sloty: entry(
    'zabawa',
    0,
    'Losuj 3 symbole; para płaci 1,5×, trójka 5×, a trzy korony 8×.',
    '/sloty stawka:100',
  ...
  wrozba: entry(
    ...
    '/wrozba pytanie:Czy dziś wygram?',
  ...
  ankieta: entry(
    ...
    '/ankieta pytanie:W co gramy? opcja1:Roblox opcja2:CS2',
  ...
  // ─────────────────────────────────────────────────────────────
  // MODERACJA — ZAAWANSOWANA
  // ─────────────────────────────────────────────────────────────
  timeout: entry(
    'moderacja',
    2,
    'Ogranicz komunikację użytkownika na 1–40 320 minut.',
    '/timeout osoba:@osoba minuty:60 powod:Powód',
  ...
  untimeout: entry(
    ...
    '/untimeout osoba:@osoba powod:Powód',
  ...
  mute: entry(
    ...
    '/mute osoba:@osoba minuty:60 powod:Powód',
  ...
  unmute: entry(
    ...
    '/unmute osoba:@osoba powod:Powód',
  ...
  unban: entry(
    ...
    '/unban id:123456789012345678 powod:Powód',
  ...
  komendy: entry(
    'zarzadzanie',
    3,
    'Sprawdź, zsynchronizuj albo wyczyść stare slash commandy aplikacji.',
    '/komendy status | synchronizuj | wyczysc_stare',
    'Wyczysc_stare usuwa globalne duchy komend i atomowo zastępuje listę komend tego serwera bieżącym zestawem. Wymagany Szef.',
  ),
  rola: entry(
    'zarzadzanie',
    3,
    'Nadaj lub zdejmij rolę z kontrolą hierarchii i ról zarządzanych.',
    '/rola nadaj|zdejmij osoba:@osoba rola:@rola',
  ...
  xp: entry(
    ...
    '/xp dodaj|odejmij|ustaw osoba:@osoba ilosc:1000',
  ...
  monety_admin: entry(
    ...
    '/monety_admin dodaj|odejmij|ustaw osoba:@osoba ilosc:500',
